  ...
  <nav className="navbar navbar-dark bg-dark border-bottom border-secondary shadow-sm py-2">
    ...
    */}
    <div className="container-fluid flex-nowrap align-items-center gap-3 overflow-x-auto custom-scrollbar-x pb-1">
      ...
      <a className="navbar-brand d-flex align-items-center flex-shrink-0 m-0" href="/">
      ...
      <div className="d-flex align-items-center flex-nowrap gap-3 m-0 p-0 flex-grow-1">
        ...
        {/* Controle de Tamanho */}
        <div className="d-flex flex-column flex-shrink-0" style={{ width: '120px' }}>
          <div className="d-flex justify-content-between align-items-center">
            <label htmlFor="brushSize" className="form-label small text-light opacity-75 mb-0" style={{ fontSize: '11px' }}>
              Tamanho:
            </label>
            <output className="badge bg-primary ms-1" style={{ fontSize: '10px' }}>{brushSize}px</output>
          </div>
          <input
            type="range"
        ...
        <div className="d-flex flex-column flex-shrink-0" style={{ width: '120px' }}>
          <div className="d-flex justify-content-between align-items-center">
            <label htmlFor="brushOpacity" className="form-label small text-light opacity-75 mb-0" style={{ fontSize: '11px' }}>
              Opacidade:
            </label>
            <output className="badge bg-primary ms-1" style={{ fontSize: '10px' }}>{Math.round(brushOpacity * 100)}%</output>
          </div>
          <input
            type="range"
        ...
        <div className="d-flex gap-1 flex-shrink-0">
          <button className="btn btn-outline-light btn-sm px-2" onClick={handleUndo} title="Desfazer" aria-label="Desfazer">
            <span aria-hidden="true">↩️</span>
          </button>
          <button className="btn btn-outline-light btn-sm px-2" onClick={handleRedo} title="Refazer" aria-label="Refazer">
            <span aria-hidden="true">↪️</span>
          </button>
